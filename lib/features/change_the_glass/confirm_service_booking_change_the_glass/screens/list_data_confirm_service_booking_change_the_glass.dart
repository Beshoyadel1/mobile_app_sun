...
class ListDataConfirmServiceBookingChangeTheGlass extends StatelessWidget {
  const ListDataConfirmServiceBookingChangeTheGlass({super.key});
    ...
    return Column(
      ...
      children: [
        ...
        ContainerServiceInListDataConfirmServiceBookingCarBatteries(
          ...
          text: AppLanguageKeys.frontGlass,
          price: '450.00',
        ),
