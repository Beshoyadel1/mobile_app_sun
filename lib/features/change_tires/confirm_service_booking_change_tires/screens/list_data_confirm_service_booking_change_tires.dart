...
class ListDataConfirmServiceBookingChangeTires extends StatelessWidget {
  const ListDataConfirmServiceBookingChangeTires({super.key});
    ...
    return Column(
      ...
      children: [
        ...
        ContainerServiceInListDataConfirmServiceBookingCarBatteries(
          ...
          text: AppLanguageKeys.tireBalancing,
          price: '450.00',
        ),
