...
import '../../../../../features/change_tires/choose_service_change_tires/choose_service_change_tires.dart';
...
class ListDataFirstScreenChangeTires extends StatelessWidget {
  const ListDataFirstScreenChangeTires({super.key});
    ...
    return Column(
      ...
      children: [
        FirstContainerInListDataFirstScreenBookingCarBatteries(
          imagePath: AppImageKeys.change_tires,
        ),
        ...
        LastButtonInListDataFirstScreenBookingCarBatteries(
          widget: ChooseServiceChangeTires(),
        )
      ],
    );
  }
